  ...
  return (
    <div className="flex flex-col items-center justify-center gap-8 px-4 text-center py-48 bg-background min-h-screen">
      ...
      <div className="space-y-4">
        <h1 className="text-8xl font-black font-headline tracking-tighter uppercase italic text-on-surface dark:text-white">
          404
        </h1>
      ...
      <Link
        href="/"
        className="bg-primary-container text-on-primary-container px-10 py-5 font-bold uppercase tracking-widest hover:brightness-110 transition-all font-headline mt-8"
      >
        Return Home
      </Link>
    </div>
